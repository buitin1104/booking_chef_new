        ...
        <div class="modal-dialog">
            <div class="modal-content">
                        ...
                        <div id="media-library" class="tab-pane active">
                            <div id="filter-media">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <button class="btn btn-success" id="media_sub_search" type="button">
                ...
                <div class="modal-footer">
                    <button type="button" id="delete-media" class="btn btn-danger" disabled='disabled'>
                        <i class="fa fa-trash"></i>
                        {{ __('Xóa') }}
                    </button>
                    <button type="button" id="insert-into-post" class="btn btn-success" disabled='disabled'>
